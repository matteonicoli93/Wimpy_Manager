            ...
            if ( Metop == 19 or Metop == 18 ):
                if (SpaGrndCon==1 or SpaGrndCon==3):
                    ...
                    if (NOAA_BOS == 'YES'):
                        ...
                        iText = str_AOS+'<br>'+str_GAC_S+'<br>'+str_GAC_E+'<br>'+str_LOS
                        
                        csv_DateT.append(iDate)
                        csv_Date.append(datatime2str_csv(iDate))
                        csv_Entry.append('Entry')
                        csv_SC.append('')
                        csv_PassOrbit.append('N'+MtOp)
                        csv_Text.append('<p>'+iText+'</p>')
...
#                     SHO_Entry= SHO_Entry + '<br>M0'+str(metop_list[i_metop])+' CDA1: TM_ROUTE: '
# =============================================================================
            if (SpaGrndCon==1 or SpaGrndCon==2):
                for i_metop in range(0,len(metop_list)):
    ...
    if (SpaGrndCon==1 or SpaGrndCon==2):
        if (XTTC_FBK_info[0]!=0):
            ...
            if (XTTC_FBK_info[1]==False):
                ...
                csv_Entry.append('Entry')
                csv_SC.append('')
                csv_PassOrbit.append(XTTC_FBK_info[3])
                ...
                iDate = iDate_AOS
                str_AOS = Date2HHMM(iDate_AOS) + ' - AOS '+space+Ant+'/TTC1 '+space+'TM: OK '+space+'TC: OK'
                str_NOS = Date2HHMM(iDate_AOS_NOP) + ' - NOP'
                str_LOS = Date2HHMM(iDate_LOS) + ' - LOS '+space+'TC Count: 000/255'
                iText = str_AOS+'<br>'+str_NOS+'<br>'+str_LOS
